...
<body>
    <div id="all">
        ...
        <div id="navigation">
            ...
            <div id="tutorias">
                    <label style="cursor:pointer;" for="click1">Tutorials</label>
            ...
            <div id="references">
                <label style="cursor:pointer;" for="click2">References</label>
            ...
            <div id="nav2">
                <a href="#"><img src="Untitled2.png" style="margin-bottom: -7px; margin-top: -2px;" /></a>
                <a href="#"><img src="Untitled3.png" style="margin-bottom: -7px; margin-top: -2px; margin-right: 10px;" /></a>
            </div>
        </div>
        <div id="menu">
            <ul>
